...
| --- | --- |
| `01-first-run.png` | No Tiiny on file. The address, the key, and the two ways to give it. |
...
| `07-settings-and-doctor.png` | Settings, and `farm doctor` rendered as sentences with their fix lines. |
